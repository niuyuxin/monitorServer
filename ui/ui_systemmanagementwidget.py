...
class Ui_SystemManagementWidget(object):
    def setupUi(self, SystemManagementWidget):
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.plcIpLineEdit)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.plcPortLineEdit)
    ...
    def retranslateUi(self, SystemManagementWidget):
        ...
        self.groupBox.setTitle(_translate("SystemManagementWidget", "网络信息"))
        self.label_8.setText(_translate("SystemManagementWidget", "网卡名字"))
        ...
        self.label_12.setText(_translate("SystemManagementWidget", "系统时间"))
        self.label_4.setText(_translate("SystemManagementWidget", "PlcIp"))
        self.label_7.setText(_translate("SystemManagementWidget", "PlcPort"))
